...
const HomePage = () => {
  ...
  return (
    <div className="p-">
      {/* 头部 */}
      <div className="bg-gradient-to-r from-background via-background to-primary/30 backdrop-blur-xl border-b border-border/60 sticky top-0 z-50 w-full shadow-sm mb-6">
